...
def vapor_loger(T,prod_run,dir2,r):
    file_to_open = dir2 + "/results/log_" + str(T) + "_" + str(r) + ".log";
...
def main():
    ...
    prod_run = 50000;
    output_file = "/morse_liq.txt";
    
    dir1,dir2 = get_current_folder();
    output_file = dir2 + output_file;
        ...
        if typer == 0:
            ...
            for T in Tref:
                for r in rnd:
                    ...
                    out_file.write("T = %.2f, Hliq = %.3f, density = %.3f\n" % (T,Hliq, density));
        else:
